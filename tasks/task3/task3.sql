...
-- товары (предположим что есть таблица с товарами)
...
-- Запрос от таблицы с товарами с джоинами через остатки и реузльтаты подзапросов (входной параметр ДАТА_С - ДАТА_ПО:
